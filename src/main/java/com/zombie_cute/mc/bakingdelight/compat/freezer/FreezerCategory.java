...
public class FreezerCategory implements DisplayCategory<FreezerDisplay> {
    public static final Identifier TEXTURE =
            new Identifier(Bakingdelight.MOD_ID, "textures/gui/rei_compat/freezer.png");
    public static final CategoryIdentifier<FreezerDisplay> FREEZING =
            CategoryIdentifier.of(Bakingdelight.MOD_ID, "freezing");

    @Override
    public CategoryIdentifier<? extends FreezerDisplay> getCategoryIdentifier() {
        return FREEZING;
    }
    ...
    @Override
    public List<Widget> setupDisplay(FreezerDisplay display, Rectangle bounds) {
