...
public class TruffleItem extends Item {
    ...
    public static final String TRUFFLE_TOOL_TIP_1 = "tooltips.bakingdelight.truffle_tool_tip_1";
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context){
        if(Screen.hasShiftDown()){
            tooltip.add(Text.translatable(TRUFFLE_TOOL_TIP_1).formatted(Formatting.AQUA));
        }else {
