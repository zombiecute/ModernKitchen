...
public class FreezerScreenHandler extends ScreenHandler {
    ...
    public FreezerScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        super(ModScreenHandlers.FREEZER_SCREEN_HANDLER_SCREEN_HANDLER,syncId);
        ...
        this.addSlot(new FurnaceOutputSlot(playerInventory.player,inventory,4,152,52));
        for (int i = 0; i < 3; ++i){
            for (int l = 0; l < 5; ++l){
